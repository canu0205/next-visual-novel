  ...
  return (
    <>
      ...
      <div className={classes.guideBox}>
        ...
        <br></br><br></br>
        The conversation will take place during 6 breaks until 7th period, and each break is 3 minutes long. Keep in mind that you can't enter other classes during class time, and you can only have one person in a class!</div>
    </div>
      </div>
    </>
  );
